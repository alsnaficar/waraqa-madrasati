...
function HomePage() {
  ...
  const madrasatiStatusQuery = useMadrasatiAuthenticationStatus();
    ...
    <PageShell>
      <div className="space-y-6">
        <DashboardHeader
          ...
          hijriDate={hijri}
          connected={
            madrasatiStatusQuery.data?.hasSession === true &&
            madrasatiStatusQuery.data?.authenticationState === "authenticated"
          }
          loading={madrasatiStatusQuery.isPending}
